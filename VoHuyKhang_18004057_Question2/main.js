...
function onup_1() { document.getElementById("title1").style.color = "red"; }
function onup_2() { document.getElementById("title2").style.color = "red"; }
function onup_3() { document.getElementById("title3").style.color = "red"; }
function onup_4() { document.getElementById("title4").style.color = "red"; }
function onup_5() { document.getElementById("title5").style.color = "red"; }
function onup_6() { document.getElementById("title6").style.color = "red"; }
function onup_7() { document.getElementById("title7").style.color = "red"; }
function onup_8() { document.getElementById("title8").style.color = "red"; }

function ondbl(){
  document.getElementById("title1").style.color = "";
  document.getElementById("title2").style.color = "";
  document.getElementById("title3").style.color = "";
  document.getElementById("title4").style.color = "";
  document.getElementById("title5").style.color = "";
  document.getElementById("title6").style.color = "";
  document.getElementById("title7").style.color = "";
  document.getElementById("title8").style.color = "";
}